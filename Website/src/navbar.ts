...
const MENU_ITEMS: MenuItem[] = [
  { label: "Mission (In Progress)", href: "/FITARNA/webpages/mission.html" },
  { label: "About Us (In Progress)", href: "/FITARNA/webpages/about_us.html" },
  { label: "Github", href: "https://github.com/jacobhallburns/FITARNA", external: true },
  { label: "Documentation (In Progress)", href: "/FITARNA/webpages/documentation.html" },
