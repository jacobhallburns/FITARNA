...
const firstSemester: MilestoneRow[] = [
  ...
  },
  {
    ...
    links: [
      { label: "Presentation", href: "/FITARNA/documentation/Milestone 2 Evaluation copy (1).pdf", external: true },
      { label: "Progress Evaluation", href: "/FITARNA/documentation/Milestone 2 Evaluation copy (1).pdf", external: true },
    ],
  },
  {
