...
const secondSemester: MilestoneRow[] = [
  {
    title: "Plan (Jan 26)",
    links: [
      { label: "Plan", href: "/FITARNA/documentation/FITARNA_Project_Plan_Fall_2026.pdf", external: true },
      { label: "Presentation", href: "/FITARNA/documentation/FITARNA_Plan_(Spring)_Presentation.pdf", external: true },
    ],
  },
  {
    title: "Milestone 4 (Feb 23)",
    links: [
      { label: "Presentation", href: "/FITARNA/documentation/Milestone_4_Presentation.pdf", external: true },
      { label: "Progress Evaluation", href: "/FITARNA/documentation/Milestone_4_Evaluation.pdf", external: true },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Demo Video", href: `${import.meta.env.BASE_URL}documentation/FITARNAdemo.mp4`, external: true },
      { label: "Demo Video TEST FILE", href: `${import.meta.env.BASE_URL}documentation/Fitarna Trailer Clean 1.mov`, external: true },
      { label: "Demo Video TEST", href: "https://www.youtube.com/watch?v=QoeLhcCIY5A", external: true },
